...
In order to reduce the manual overhead, a CLIPS abstraction layer is provided, which takes care of the ROS communication.
...
Other planners can be used as well, given they are integrated with the Unified Planning Framework and available on your system.
