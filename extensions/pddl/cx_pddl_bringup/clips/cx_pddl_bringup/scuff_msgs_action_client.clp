...
(defrule scuff-client-send-goal-assemble-start
  ...
  (pddl-action (id ?id) (name assemble-start|disassemble-start) (params ?prod $?params))
...
(defrule scuff-client-process-assemble-end
  (scuff-msgs-string-command-client (server ?server))
  ?ex <- (pddl-action-executor (action ?id) (state INIT))
  (pddl-action (id ?id) (name assemble-end|disassemble-end) (params ?prod $?params))
  (test (neq (ros-param-get-value "pddl.assembly" "timer") "timer"))
  =>
...
(defrule scuff-client-cleanup-after-wrapped-result
  ...
  (pddl-action (id ?action-id) (name assemble-end|disassemble-end) (params $?action-params))
  (pddl-action (id ?o-action-id) (name assemble-start|disassemble-start) (params $?action-params))
