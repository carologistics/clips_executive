...
=>
  ...
  (assert
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 19) (name put) (params WB2))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 26) (name put) (params WB2))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 50) (name pick) (params WB2))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 46) (name pick) (params WB2))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 4) (name pick) (params WB2))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 5) (name put) (params HS))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 6) (name pick) (params WB2))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 7) (name put) (params SS1))
    ;disassemble hammer
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 2) (name pick) (params CC))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 3) (name put) (params WB2))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 13) (name put) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 14) (name pick) (params WB2))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 15) (name put) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 16) (name pick) (params WB2))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 17) (name put) (params SS1))
  )
)
