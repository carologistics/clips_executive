...
=>
  ...
  (assert
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 1) (name put) (params SS3))
    ;estop cap pick and place
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 2) (name pick) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 3) (name put) (params SS3))
    ;(pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 4) (name assemble-start) (params estop))
    ;carrot 1st piece pick
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 5) (name pick) (params SS2))
    ;(pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 6) (name assemble-end) (params estop))
    ;carrot 1st piece put
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 7) (name put) (params SS3))
    ;deliver e-stop
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 8) (name pick) (params SS3))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 9) (name put) (params WB2))
    ;carrot 2nd place pick and place
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 10) (name pick) (params SS2))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 11) (name put) (params SS3))
    ;(pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 12) (name assemble-start) (params carrot-base))
    ;pick and place carrot cap
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 13) (name pick) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 14) (name put) (params SS3))
    ...
    ;deliver carrot
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 20) (name pick) (params SS3))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 21) (name put) (params WB2))
  )
)
