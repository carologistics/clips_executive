...
=>
  ...
  (assert
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 4) (name pick) (params WB1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 5) (name put) (params HS))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 6) (name pick) (params WB1))
    ...
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 12) (name pick) (params WB1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 13) (name put) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 14) (name pick) (params WB1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 15) (name put) (params SS1))
    (pddl-action (id (gensym*)) (plan game1) (state IDLE) (order 16) (name pick) (params WB1))
