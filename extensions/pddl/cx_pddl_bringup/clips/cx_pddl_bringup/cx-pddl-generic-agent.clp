...
=>
  ...
  (assert
    ...
    (pddl-action (plan game1) (state IDLE) (order 0) (name pick) (params SS2-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 1) (name put) (params WB1-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 2) (name pick) (params SS1-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 3) (name put) (params WB1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 4) (name assemble-start) (params estop))
    (pddl-action (plan game1) (state IDLE) (order 5) (name pick) (params SS2-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 6) (name assemble-end) (params estop))
    (pddl-action (plan game1) (state IDLE) (order 7) (name put) (params WB1-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 8) (name pick) (params WB1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 9) (name put) (params CC-LEFT))
    ;delivered estop
    (pddl-action (plan game1) (state IDLE) (order 10) (name pick) (params SS2-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 11) (name put) (params WB1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 12) (name assemble-start) (params carrot-base))
    (pddl-action (plan game1) (state IDLE) (order 13) (name pick) (params SS1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 14) (name put) (params WB1-LEFT))
    (pddl-action (plan game1) (state IDLE) (order 15) (name pick) (params SS2-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 16) (name assemble-end) (params carrot-base))
    (pddl-action (plan game1) (state IDLE) (order 17) (name put) (params WB1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 18) (name assemble-start) (params carrot-cap))
    (pddl-action (plan game1) (state IDLE) (order 19) (name assemble-end) (params carrot-cap))
    (pddl-action (plan game1) (state IDLE) (order 20) (name pick) (params WB1-RIGHT))
    (pddl-action (plan game1) (state IDLE) (order 21) (name put) (params CC-RIGHT))
    ;delivered battery
  )
)
