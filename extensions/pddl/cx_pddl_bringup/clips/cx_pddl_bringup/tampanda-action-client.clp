...
(defglobal
  ?*TAMPANDA-ACTION-SERVICE* = "execute_pddl_action"
)
...
" Create a simple client using the generated bindings. "
  (not (tampanda-ros-interfaces-execute-pddl-action-client (server ?server&:(eq ?server ?*TAMPANDA-ACTION-SERVICE*))))
  (not (executive-finalize))
=>
  (tampanda-ros-interfaces-execute-pddl-action-create-client ?*TAMPANDA-ACTION-SERVICE*)
