...
" Call a planner based on a pddl-plan fact."
  ...
  ?pp <- (pddl-plan (instance ?instance) (goal ?goal) (type TEMPORAL) (state PENDING) (output-dir ?dir))
  ...
  (cx-pddl-interfaces-plan-temporal-goal-set-field ?goal-msg "output_dir" ?dir)
