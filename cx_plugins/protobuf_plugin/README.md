...
<a id="usage-protobuf-plugin"></a>

# Protobuf Plugin

Source code on [GitHub](https://github.com/carologistics/clips_executive/blob/master/cx_plugins/protobuf_plugin).

This plugin enables communication via protobuf through [protobuf_comm](https://carologistics.github.io/clips_executive/protobuf_comm), a C++ library to handle communication via Protocol Buffers ([protobuf](https://protobuf.dev/)) using a simple framing protocol.
...
The utilized [protobuf_comm](https://carologistics.github.io/clips_executive/protobuf_comm) library (de)-serializes proto using a framing protocol that other communication endpoints therefore need to adhere to, as well.
Refer to it’s documentation to get details on the layout of the frame headers.

It requires messages using [proto2](https://protobuf.dev/programming-guides/proto2/) syntax that additionally define a `CompType` enum acting as a unique identifier (using a tmple `COMP_ID` and `MESSAGE_TYPE`.
...
However, this requires to build a shared library from proto files and then link it together with the [cx_protobuf_plugin](https://carologistics.github.io/clips_executive/cx_protobuf_plugin) plugin, creating a new linked plugin.
...
A minimal working example is provided by the [cx_bringup](https://carologistics.github.io/clips_executive/cx_bringup) package.
...
<a id="proto-msg-example"></a>

### Message

File [cx_bringup/proto/cx_bringup/SearchRequest.proto](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/proto/cx_bringup/SearchRequest.proto).
...
File [cx_bringup/params/plugin_examples/protobuf.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/protobuf.yaml).
...
File [cx_bringup/clips/plugin_examples/protobuf-peer1.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/protobuf-peer1.clp).
...
File [cx_bringup/clips/plugin_examples/protobuf-peer2.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/protobuf-peer2.clp).
...
It creates a server on port `4446` and a client (in a separate CLIPS environment) that sends messages (using the same [message definitions](#proto-msg-example) as in the first example).
...
File [cx_bringup/params/plugin_examples/protobuf_linked.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/protobuf_linked.yaml).
...
File [cx_bringup/clips/plugin_examples/protobuf-linked-client.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/protobuf-linked-client.clp).
...
File [cx_bringup/clips/plugin_examples/protobuf-linked-server.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/protobuf-linked-server.clp).
