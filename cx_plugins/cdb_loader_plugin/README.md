...
<a id="usage-cdb-loader-plugin"></a>

# CDB Loader Plugin

Source code on [GitHub](https://github.com/carologistics/clips_executive/blob/master/cx_plugins/cdb_loader_plugin).

This plugin is part of the **C**LIPS **D**e**B**ugger (CDB) suite of the ROS2 CLIPS-Executive.

This plugin allows to restore the ROS2 CLIPS-Executive using execution traces from a [Postgresql](https://www.postgresql.org/) database, as recorded by the [CDB Saver Plugin](cdb_saver_plugin.md#usage-cdb-saver-plugin).

## Configuration

<a id="cdb-loader-host"></a>
* **host:**
  | Type   | Default     |
  |--------|-------------|
  | string | “localhost” |
...
<a id="cdb-loader-restore-method"></a>
* **password:**
  | Type   | Default   |
  |--------|-----------|
  | string | “run”     |
  ...
  : Method to use when restoring. Allowed values are [“run”, “tick”, “time”].
    See also [restore_run](#cdb-loader-restore-run), [restore_tick](#cdb-loader-restore-tick),
    [restore_time](#cdb-loader-restore-time).

<a id="cdb-loader-restore-run"></a>
* **restore_run:**
  | Type   |   Default |
  |--------|-----------|
  | int    |         0 |
...
<a id="cdb-loader-restore-tick"></a>
* **restore_tick:**
  | Type   |   Default |
  |--------|-----------|
  | int    |         0 |
...
<a id="cdb-loader-restore-time"></a>
* **restore_time:**
  | Type   | Default   |
  |--------|-----------|
  | string | “”        |
...
<a id="cdb-loader-drop-external-addresses"></a>
...
<a id="cdb-loader-restore-as-nullptr"></a>
...
<a id="cdb-loader-construct-skip"></a>
* **<construct>.skip:**
  | Type   | Default   |
  |--------|-----------|
  | bool   | false     |
...
<a id="cdb-loader-construct-load-if"></a>
...
<a id="cdb-loader-consruct-skip-if"></a>
...
<a id="cdb-loader-deffacts-manual-assert"></a>
...
To assert them manually, enable deffacts.manual_assert <cdb_loader_deffacts_manual_assert.
...
A minimal working example is provided by the [cx_bringup](https://carologistics.github.io/clips_executive/cx_bringup) package. Run the example code from the CDB saver plugin to obtain a database to restore:
...
File [cx_bringup/clips/plugin_examples/cdb-loader.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/cdb-loader.clp).
