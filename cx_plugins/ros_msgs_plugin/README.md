...
<a id="usage-ros-msgs-plugin"></a>

# Generic ROS Msg Plugin

Source code on [GitHub](https://github.com/carologistics/clips_executive/blob/master/cx_plugins/ros_msgs_plugin).
...
File [cx_bringup/params/plugin_examples/ros_msgs.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/ros_msgs.yaml).
...
File [cx_bringup/clips/plugin_examples/ros-msgs.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/ros-msgs.clp).
...
File [cx_bringup/params/plugin_examples/ros_msgs_client.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/ros_msgs_client.yaml).
...
File [cx_bringup/clips/plugin_examples/ros-msgs-client.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/ros-msgs-client.clp).
...
File [cx_bringup/params/plugin_examples/ros_msgs_service.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/ros_msgs_service.yaml).
...
File [cx_bringup/clips/plugin_examples/ros-msgs-service.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/ros-msgs-service.clp).
...
: - One environment provides an action server that computes Fibonacci sequences. It is implemented using generated bindings for the server via [cx_ros_comm_gen](https://carologistics.github.io/clips_executive/cx_ros_comm_gen).
...
File [cx_bringup/params/plugin_examples/ros_msgs_action_client.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/params/plugin_examples/ros_msgs_action_client.yaml).
...
File [cx_bringup/clips/plugin_examples/ros-msgs-action-client.clp](https://github.com/carologistics/clips_executive/blob/master/cx_bringup/clips/plugin_examples/ros-msgs-action-client.clp).
