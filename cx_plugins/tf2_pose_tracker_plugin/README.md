...
<a id="usage-tf2-pose-tracker-plugin"></a>

# TF2 Pose Tracker Plugin

Source code on [GitHub](https://github.com/carologistics/clips_executive/blob/master/cx_plugins/tf2_pose_tracker-plugin).
...
File [cx_tutorial_agents/params/tf2_tracked_pose.yaml](https://github.com/carologistics/clips_executive/blob/master/cx_tutorial_agents/params/tf2_tracked_pose.yaml).
...
File [cx_tutorial_agents/clips/tf2_tracked_pose.clp](https://github.com/carologistics/clips_executive/blob/master/cx_tutorial_agents/clips/tf2_tracked_pose.clp).
